...
globalStyle(
  "hanko-profile::part(input text-input):-webkit-autofill, " +
    "hanko-profile::part(input text-input):-webkit-autofill:hover, " +
    "hanko-profile::part(input text-input):-webkit-autofill:focus",
  {
