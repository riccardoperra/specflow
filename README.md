...
- Profile
    ...
    - [hanko-profile-overrides.css](src/components/Auth/hanko-profile-overrides.css): Hanko profile css overrides injected
      into
      the shadow dom
- Shared
...
Each web component will have attached a custom class generated by vanilla-extract, then a custom `<style>` tag inside the
